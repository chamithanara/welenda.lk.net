...
.factory('Fabric', [
	...
	return function(options) {
        ...
        fabric.Object.prototype.customiseCornerIcons( {
            ...
            tl: {
                icon: 'DesingTailorSource/images/icons/rotate.jpg'
            },
            tr: {
                icon: 'DesingTailorSource/images/icons/resize.jpg'
            },
            bl: {
                icon: 'DesingTailorSource/images/icons/delete.png'
            },
            br: {
                icon: 'DesingTailorSource/images/icons/move.jpg'
            },
            mb: {
                icon: 'DesingTailorSource/images/icons/move.jpg'
            },
       ...
       /***************** for corner icons  ****************/
        ...
        self.saveCanvasObject = function() {
            ...
            var currentFontUrl = window.location.href.split('/')[0] + "/DesingTailorSource/fonts.css";

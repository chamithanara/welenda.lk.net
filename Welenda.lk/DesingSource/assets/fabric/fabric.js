...
.factory('Fabric', [
	...
	return function(options) {
        ...
        fabric.Object.prototype.customiseCornerIcons( {
            ...
            tl: {
                icon: 'DesingSource/images/icons/rotate.jpg'
            },
            tr: {
                icon: 'DesingSource/images/icons/resize.jpg'
            },
            bl: {
                icon: 'DesingSource/images/icons/delete.png'
            },
            br: {
                icon: 'DesingSource/images/icons/move.jpg'
            },
            mb: {
                icon: 'DesingSource/images/icons/move.jpg'
            },
       ...
       /***************** for corner icons  ****************/
        ...
        self.saveCanvasObject = function() {
            ...
            var currentFontUrl = window.location.href.split('/')[0] + "/DesingSource/fonts.css";
